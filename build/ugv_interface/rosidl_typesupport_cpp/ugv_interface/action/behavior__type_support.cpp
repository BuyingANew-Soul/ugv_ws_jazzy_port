...
typedef struct _Behavior_SendGoal_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _Behavior_SendGoal_Event_type_support_ids_t;

static const _Behavior_SendGoal_Event_type_support_ids_t _Behavior_SendGoal_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _Behavior_SendGoal_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _Behavior_SendGoal_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _Behavior_SendGoal_Event_type_support_symbol_names_t _Behavior_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_interface, action, Behavior_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ugv_interface, action, Behavior_SendGoal_Event)),
  }
};

typedef struct _Behavior_SendGoal_Event_type_support_data_t
{
  void * data[2];
} _Behavior_SendGoal_Event_type_support_data_t;

static _Behavior_SendGoal_Event_type_support_data_t _Behavior_SendGoal_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _Behavior_SendGoal_Event_message_typesupport_map = {
  2,
  "ugv_interface",
  &_Behavior_SendGoal_Event_message_typesupport_ids.typesupport_identifier[0],
  &_Behavior_SendGoal_Event_message_typesupport_symbol_names.symbol_name[0],
  &_Behavior_SendGoal_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t Behavior_SendGoal_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_Behavior_SendGoal_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::ugv_interface::action::rosidl_typesupport_cpp::Behavior_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ugv_interface, action, Behavior_SendGoal_Event)() {
  return get_message_type_support_handle<ugv_interface::action::Behavior_SendGoal_Event>();
}
...
static const rosidl_service_type_support_t Behavior_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_SendGoal_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_SendGoal_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_SendGoal_Event>(),
...
typedef struct _Behavior_GetResult_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _Behavior_GetResult_Event_type_support_ids_t;

static const _Behavior_GetResult_Event_type_support_ids_t _Behavior_GetResult_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _Behavior_GetResult_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _Behavior_GetResult_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _Behavior_GetResult_Event_type_support_symbol_names_t _Behavior_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_interface, action, Behavior_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ugv_interface, action, Behavior_GetResult_Event)),
  }
};

typedef struct _Behavior_GetResult_Event_type_support_data_t
{
  void * data[2];
} _Behavior_GetResult_Event_type_support_data_t;

static _Behavior_GetResult_Event_type_support_data_t _Behavior_GetResult_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _Behavior_GetResult_Event_message_typesupport_map = {
  2,
  "ugv_interface",
  &_Behavior_GetResult_Event_message_typesupport_ids.typesupport_identifier[0],
  &_Behavior_GetResult_Event_message_typesupport_symbol_names.symbol_name[0],
  &_Behavior_GetResult_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t Behavior_GetResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_Behavior_GetResult_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::ugv_interface::action::rosidl_typesupport_cpp::Behavior_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ugv_interface, action, Behavior_GetResult_Event)() {
  return get_message_type_support_handle<ugv_interface::action::Behavior_GetResult_Event>();
}
...
static const rosidl_service_type_support_t Behavior_GetResult_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_service_typesupport_handle_function,
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_GetResult_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_GetResult_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ugv_interface::action::Behavior_GetResult_Event>(),
