...
class Metaclass_MapSave_Event(type):
    """Metaclass of message 'MapSave_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__map_save__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__map_save__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__map_save__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__map_save__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__map_save__event
...
class MapSave_Event(metaclass=Metaclass_MapSave_Event):
    """Message class 'MapSave_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ugv_interface/MapSave_Request, 1>',
        'response': 'sequence<ugv_interface/MapSave_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ugv_interface', 'srv'], 'MapSave_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ugv_interface', 'srv'], 'MapSave_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ugv_interface.srv import MapSave_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MapSave_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MapSave_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ugv_interface.srv import MapSave_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MapSave_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MapSave_Response'"
        self._response = value
...
class Metaclass_MapSave(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _map_save.Metaclass_MapSave_Event._TYPE_SUPPORT is None:
                _map_save.Metaclass_MapSave_Event.__import_type_support__()
...
class MapSave(metaclass=Metaclass_MapSave):
    ...
    from ugv_interface.srv._map_save import MapSave_Event as Event
