...
ugv_interface__srv__MapSave_Request__create(void)
{
...
ugv_interface__srv__MapSave_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
ugv_interface__srv__MapSave_Event__init(ugv_interface__srv__MapSave_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ugv_interface__srv__MapSave_Event__fini(msg);
    return false;
  }
  // request
  if (!ugv_interface__srv__MapSave_Request__Sequence__init(&msg->request, 0)) {
    ugv_interface__srv__MapSave_Event__fini(msg);
    return false;
  }
  // response
  if (!ugv_interface__srv__MapSave_Response__Sequence__init(&msg->response, 0)) {
    ugv_interface__srv__MapSave_Event__fini(msg);
    return false;
  }
  return true;
...
void
ugv_interface__srv__MapSave_Event__fini(ugv_interface__srv__MapSave_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  ugv_interface__srv__MapSave_Request__Sequence__fini(&msg->request);
  // response
  ugv_interface__srv__MapSave_Response__Sequence__fini(&msg->response);
}

bool
ugv_interface__srv__MapSave_Event__are_equal(const ugv_interface__srv__MapSave_Event * lhs, const ugv_interface__srv__MapSave_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!ugv_interface__srv__MapSave_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ugv_interface__srv__MapSave_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
ugv_interface__srv__MapSave_Event__copy(
  const ugv_interface__srv__MapSave_Event * input,
  ugv_interface__srv__MapSave_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!ugv_interface__srv__MapSave_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ugv_interface__srv__MapSave_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
ugv_interface__srv__MapSave_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__srv__MapSave_Event * msg = (ugv_interface__srv__MapSave_Event *)allocator.allocate(sizeof(ugv_interface__srv__MapSave_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ugv_interface__srv__MapSave_Event));
  bool success = ugv_interface__srv__MapSave_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
ugv_interface__srv__MapSave_Event__destroy(ugv_interface__srv__MapSave_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ugv_interface__srv__MapSave_Event__fini(msg);
...
bool
ugv_interface__srv__MapSave_Event__Sequence__init(ugv_interface__srv__MapSave_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__srv__MapSave_Event * data = NULL;

  if (size) {
    data = (ugv_interface__srv__MapSave_Event *)allocator.zero_allocate(size, sizeof(ugv_interface__srv__MapSave_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ugv_interface__srv__MapSave_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ugv_interface__srv__MapSave_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
ugv_interface__srv__MapSave_Event__Sequence__fini(ugv_interface__srv__MapSave_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ugv_interface__srv__MapSave_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
ugv_interface__srv__MapSave_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ugv_interface__srv__MapSave_Event__Sequence * array = (ugv_interface__srv__MapSave_Event__Sequence *)allocator.allocate(sizeof(ugv_interface__srv__MapSave_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ugv_interface__srv__MapSave_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
ugv_interface__srv__MapSave_Event__Sequence__destroy(ugv_interface__srv__MapSave_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ugv_interface__srv__MapSave_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
ugv_interface__srv__MapSave_Event__Sequence__are_equal(const ugv_interface__srv__MapSave_Event__Sequence * lhs, const ugv_interface__srv__MapSave_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ugv_interface__srv__MapSave_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ugv_interface__srv__MapSave_Event__Sequence__copy(
  const ugv_interface__srv__MapSave_Event__Sequence * input,
  ugv_interface__srv__MapSave_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ugv_interface__srv__MapSave_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ugv_interface__srv__MapSave_Event * data =
      (ugv_interface__srv__MapSave_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ugv_interface__srv__MapSave_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ugv_interface__srv__MapSave_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ugv_interface__srv__MapSave_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
