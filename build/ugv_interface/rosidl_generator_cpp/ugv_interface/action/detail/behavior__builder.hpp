...
{
public:
  explicit Init_Behavior_SendGoal_Event_response(::ugv_interface::action::Behavior_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::ugv_interface::action::Behavior_SendGoal_Event response(::ugv_interface::action::Behavior_SendGoal_Event::_response_type arg)
  {
...
private:
  ::ugv_interface::action::Behavior_SendGoal_Event msg_;
};

class Init_Behavior_SendGoal_Event_request
{
public:
  explicit Init_Behavior_SendGoal_Event_request(::ugv_interface::action::Behavior_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Behavior_SendGoal_Event_response request(::ugv_interface::action::Behavior_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Behavior_SendGoal_Event_request info(::ugv_interface::action::Behavior_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::ugv_interface::action::Behavior_SendGoal_Event>()
{
  return ugv_interface::action::builder::Init_Behavior_SendGoal_Event_info();
}
...
{
public:
  explicit Init_Behavior_GetResult_Event_response(::ugv_interface::action::Behavior_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::ugv_interface::action::Behavior_GetResult_Event response(::ugv_interface::action::Behavior_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::ugv_interface::action::Behavior_GetResult_Event msg_;
};

class Init_Behavior_GetResult_Event_request
{
public:
  explicit Init_Behavior_GetResult_Event_request(::ugv_interface::action::Behavior_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Behavior_GetResult_Event_response request(::ugv_interface::action::Behavior_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Behavior_GetResult_Event_request info(::ugv_interface::action::Behavior_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::ugv_interface::action::Behavior_GetResult_Event>()
{
  return ugv_interface::action::builder::Init_Behavior_GetResult_Event_info();
}
