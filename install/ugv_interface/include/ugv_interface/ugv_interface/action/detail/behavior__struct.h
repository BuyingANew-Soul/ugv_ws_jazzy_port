...
enum
{
  ugv_interface__action__Behavior_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ugv_interface__action__Behavior_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Behavior in the package ugv_interface.
typedef struct ugv_interface__action__Behavior_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ugv_interface__action__Behavior_SendGoal_Request__Sequence request;
  ugv_interface__action__Behavior_SendGoal_Response__Sequence response;
} ugv_interface__action__Behavior_SendGoal_Event;

// Struct for a sequence of ugv_interface__action__Behavior_SendGoal_Event.
typedef struct ugv_interface__action__Behavior_SendGoal_Event__Sequence
{
...
enum
{
  ugv_interface__action__Behavior_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ugv_interface__action__Behavior_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Behavior in the package ugv_interface.
typedef struct ugv_interface__action__Behavior_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ugv_interface__action__Behavior_GetResult_Request__Sequence request;
  ugv_interface__action__Behavior_GetResult_Response__Sequence response;
} ugv_interface__action__Behavior_GetResult_Event;

// Struct for a sequence of ugv_interface__action__Behavior_GetResult_Event.
typedef struct ugv_interface__action__Behavior_GetResult_Event__Sequence
{
